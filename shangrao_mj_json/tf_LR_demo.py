...
flags.DEFINE_string("model_dir", "D:\\datasets\\adult", "Base directory for output models.")
...
flags.DEFINE_string(
    "train_data",
    "D:\\datasets\\adult\\adult.data",
    "Path to the training data.")
# 设置存放test_data的目录，在第二个变量设置
flags.DEFINE_string(
    "test_data",
    "D:\\datasets\\adult\\adult.test",
